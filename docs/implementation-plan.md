...
5. OAuth2 provider factory 생성
6. Spring Security config 생성
7. OAuth2 login success handler 생성
8. JWT access token 발급 구현
9. Refresh token 저장 구현
10. `/api/v1/auth/me` 구현
11. `/api/v1/auth/refresh` 구현
12. `/api/v1/auth/logout` 구현
13. 소셜 계정 연결/해제 API 구현
14. 회원 탈퇴 soft delete 구현
15. 인증 API 문서 작성
16. 인증 테스트 작성
...
6. dashboard page 구성
7. project list page 구성
8. project detail page 구성
9. upload page 구성
10. upload progress 표시
11. job create form 구성
12. job detail page 구성
13. SSE progress 연결
14. image detail page 구성
15. 원본/결과 비교 뷰 구성
16. processing report 표시
17. failed item retry 버튼 구성
18. benchmark page 구성
19. admin page 구성
20. notification 표시
21. frontend 문서 작성
22. frontend 테스트 작성
