...
public class UploadSessionService {
    ...
    public UploadSessionResponse create(Long currentUserId, Long projectId, UploadSessionCreateRequest request) {
        projectPermissionService.validateEditable(projectId, currentUserId);
    ...
    public UploadSessionResponse findOne(Long currentUserId, Long sessionId) {
        UploadSession uploadSession = findById(sessionId);
        projectPermissionService.validateReadable(uploadSession.getProjectId(), currentUserId);
        return UploadSessionResponse.from(uploadSession);
    }
    ...
    public void cancel(Long currentUserId, Long sessionId) {
        ...
        if (!uploadSession.isOpen()) {
            throw new UploadNotCompletedException("Upload session cannot be cancelled.");
        }
    ...
    private UploadSession findById(Long sessionId) {
